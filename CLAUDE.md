...
- **Next slices (in order):** quick-add (FAB + bottom sheet, title+time only) → swipe gestures (complete/delete with reanimated springs + undo toast + haptics) → Today view → completed-group collapse + bulk clear → task edit form.
