...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    anchor: 'form-subject',
    title: 'Subject',
    body: 'The topic inside a category. Chemistry inside School. Meetings inside Work. Categories are the big boxes, subjects are what is in them. Pick or make one.',
    placement: 'top',
